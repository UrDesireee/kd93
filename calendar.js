document.addEventListener('DOMContentLoaded', () => {
    ...
    if (currentEventElement && eventsContainer) {
        const events = [
            ...
            { name: "Waiting period for activation lvl 5 pass", time: "2024-09-29 18:21:48" },
            { name: "Your alliance controlled ONE lvl. 5 pass", time: "2024-09-30 06:21:48" },
            { name: "Your CH is lvl 25", time: "2024-10-01 18:21:48" },
            { name: "Waiting period for activation Circles", time: "2024-10-02 18:21:48" },
            { name: "Your alliance controls ONE Circle", time: "2024-10-03 06:21:48" },
            { name: "Waiting period for activation Altar of Darkness", time: "2024-10-04 18:21:48" },
            { name: "Your troops defeated 3 Dark Stalkers", time: "2024-10-05 06:21:48" },
            { name: "Your alliance destroyed 50 lvl. 9 barbarian forts", time: "2024-10-06 18:21:48" },
            { name: "Waiting period for activation lvl 6 pass", time: "2024-10-08 18:21:48" },
            { name: "Your alliance controlled ONE lvl. 6 pass", time: "2024-10-09 06:21:48" },
            { name: "Kill 100k lvl 36+ barbs", time: "2024-10-10 18:21:48" },
            { name: "Your alliance destroyed 50 lvl. 10 barbarian forts", time: "2024-10-11 18:21:48" },
            { name: "Waiting period for Great Ziggurat", time: "2024-10-13 18:21:48" },
            { name: "Your alliance controls the Great Ziggurat", time: "2024-10-14 06:21:48" },
            { name: "Waiting period for lvl. 4 passes (unsealed)", time: "2024-10-17 06:21:48" },
            { name: "Your camp controlled 3 other camps' Crusader camps", time: "2024-10-17 18:21:48" },
            { name: "Your troops killed 1,000,000 troops from other camps", time: "2024-10-19 06:21:48" },
            { name: "Your camp controlled 1 other camp's Crusader Fortress", time: "2024-10-20 06:21:48" }
        ];
