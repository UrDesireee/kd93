document.addEventListener('DOMContentLoaded', () => {
    ...
    if (currentEventElement && eventsContainer) {
        const events = [
            ...
            { name: "Waiting period for activation lvl 5 pass", time: "2024-09-30 15:26:48" },
            { name: "Your alliance controlled ONE lvl. 5 pass", time: "2024-10-01 03:26:48" },
            { name: "Your CH is lvl 25", time: "2024-10-02 15:26:48" },
            { name: "Waiting period for activation Circles", time: "2024-10-03 15:26:48" },
            { name: "Your alliance controls ONE Circle", time: "2024-10-04 03:26:48" },
            { name: "Waiting period for activation Altar of Darkness", time: "2024-10-05 15:26:48" },
            { name: "Your troops defeated 3 Dark Stalkers", time: "2024-10-06 03:26:48" },
            { name: "Your alliance destroyed 50 lvl. 9 barbarian forts", time: "2024-10-07 15:26:48" },
            { name: "Waiting period for activation lvl 6 pass", time: "2024-10-09 15:26:48" },
            { name: "Your alliance controlled ONE lvl. 6 pass", time: "2024-10-10 03:26:48" },
            { name: "Kill 100k lvl 36+ barbs", time: "2024-10-11 15:26:48" },
            { name: "Your alliance destroyed 50 lvl. 10 barbarian forts", time: "2024-10-12 15:26:48" },
            { name: "Waiting period for Great Ziggurat", time: "2024-10-14 15:26:48" },
            { name: "Your alliance controls the Great Ziggurat", time: "2024-10-15 03:26:48" },
            { name: "Waiting period for lvl. 4 passes (unsealed)", time: "2024-10-18 03:26:48" },
            { name: "Your camp controlled 3 other camps' Crusader camps", time: "2024-10-18 15:26:48" },
            { name: "Your troops killed 1,000,000 troops from other camps", time: "2024-10-20 03:26:48" },
            { name: "Your camp controlled 1 other camp's Crusader Fortress", time: "2024-10-21 03:26:48" }
        ];
