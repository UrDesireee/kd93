document.addEventListener('DOMContentLoaded', () => {
    ...
    if (currentEventElement && eventsContainer) {
        const events = [
            ...
            { name: "A total of 300 crusader flags were built between all alliances in the Lost Kingdom. Time Flexible. Stage ends when goal is reached.", time: "2024-09-23 13:26:00" },
            { name: "Waiting period for activation Sanctuaries", time: "2024-09-25 13:26:00" },
            { name: "Your alliance controls ONE Sanctuary", time: "2024-09-27 03:26:48" },
            { name: "Your camp destroyed 50 lvl 8 barbarian forts", time: "2024-09-28 15:26:48" },
            { name: "Waiting period for activation lvl 5 pass", time: "2024-09-29 03:26:49" },
            { name: "Your alliance controlled ONE lvl. 5 pass", time: "2024-09-29 15:26:49" },
            { name: "Your CH is lvl 25", time: "2024-10-01 03:26:49" },
            { name: "Waiting period for activation Circles", time: "2024-10-02 03:26:49" },
            { name: "Your alliance controls ONE Circle", time: "2024-10-02 15:26:49" },
            { name: "Waiting period for activation Altar of Darkness", time: "2024-10-04 03:26:49" },
            { name: "Your troops defeated 3 Dark Stalkers", time: "2024-10-04 15:26:49" },
            { name: "Your alliance destroyed 50 lvl. 9 barbarian forts", time: "2024-10-06 03:26:49" },
            { name: "Waiting period for activation lvl 6 pass", time: "2024-10-08 03:26:49" },
            { name: "Your alliance controlled ONE lvl. 6 pass", time: "2024-10-08 15:26:49" },
            { name: "Kill 100k lvl 36+ barbs", time: "2024-10-10 03:26:49" },
            { name: "Your alliance destroyed 50 lvl. 10 barbarian forts", time: "2024-10-11 03:26:49" },
            { name: "Waiting period for Great Ziggurat", time: "2024-10-13 03:26:49" },
            { name: "Your alliance controls the Great Ziggurat", time: "2024-10-13 15:26:49" },
            { name: "Waiting period for lvl. 4 passes, unsealed", time: "2024-10-16 15:26:49" },
            { name: "Your camp controlled 3 other camps' Crusader camps", time: "2024-10-17 03:26:49" },
            { name: "Your troops killed 1,000,000 troops from other camps", time: "2024-10-18 15:26:49" },
            { name: "Your camp controlled 1 other camp's Crusader Fortress", time: "2024-10-19 15:26:49" }
        ];
