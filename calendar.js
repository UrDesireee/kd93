document.addEventListener('DOMContentLoaded', () => {
    ...
    if (currentEventElement && eventsContainer) {
        const events = [
            ...
            { name: "Your camp destroyed 50 lvl 8 barbarian forts", time: "2024-09-27 15:26:24" },
            { name: "Waiting period for activation lvl 5 pass", time: "2024-09-29 15:26:48" },
            { name: "Your alliance controlled ONE lvl. 5 pass", time: "2024-09-30 03:26:48" },
            { name: "Your CH is lvl 25", time: "2024-10-01 15:26:48" },
            { name: "Waiting period for activation Circles", time: "2024-10-02 15:26:48" },
            { name: "Your alliance controls ONE Circle", time: "2024-10-03 03:26:48" },
            { name: "Waiting period for activation Altar of Darkness", time: "2024-10-04 15:26:48" },
            { name: "Your troops defeated 3 Dark Stalkers", time: "2024-10-05 03:26:48" },
            { name: "Your alliance destroyed 50 lvl. 9 barbarian forts", time: "2024-10-06 15:26:48" },
            { name: "Waiting period for activation lvl 6 pass", time: "2024-10-08 15:26:48" },
            { name: "Your alliance controlled ONE lvl. 6 pass", time: "2024-10-09 03:26:48" },
            { name: "Kill 100k lvl 36+ barbs", time: "2024-10-10 15:26:48" },
            { name: "Your alliance destroyed 50 lvl. 10 barbarian forts", time: "2024-10-11 15:26:48" },
            { name: "Waiting period for Great Ziggurat", time: "2024-10-13 15:26:48" },
            { name: "Your alliance controls the Great Ziggurat", time: "2024-10-14 03:26:48" },
            { name: "Waiting period for lvl. 4 passes, unsealed", time: "2024-10-17 03:26:48" },
            { name: "Your camp controlled 3 other camps' Crusader camps", time: "2024-10-17 15:26:48" },
            { name: "Your troops killed 1,000,000 troops from other camps", time: "2024-10-19 03:26:48" },
            { name: "Your camp controlled 1 other camp's Crusader Fortress", time: "2024-10-20 03:26:48" }
        ];
