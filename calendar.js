document.addEventListener('DOMContentLoaded', () => {
    ...
    if (currentEventElement && eventsContainer) {
        const events = [
            ...
            { name: "Top 20 for total power", time: "2024-09-21 00:00:00" },
            { name: "Waiting period for activation Ancient Ruins", time: "2024-09-22 00:00:00" },
            { name: "Your troops defeated 3 Stalkers", time: "2024-09-22 12:00:00" },
            { name: "A total of 300 crusader flags built between all alliances in the Lost Kingdom. Time Flexible.", time: "2024-09-24 00:00:00" },
            { name: "Waiting period for activation Sanctuaries", time: "2024-09-26 00:00:00" },
            { name: "Your alliance controls ONE Sanctuary", time: "2024-09-26 12:00:00" },
            { name: "Your camp destroyed 50 lvl 8 barbarian forts", time: "2024-09-28 00:00:00" },
            { name: "Waiting period for activation lvl 5 pass", time: "2024-09-30 00:00:00" },
            { name: "Your alliance controlled ONE lvl. 5 pass", time: "2024-09-30 12:00:00" },
            { name: "Your CH is lvl 25", time: "2024-10-02 00:00:00" },
            { name: "Waiting period for activation Circles", time: "2024-10-03 00:00:00" },
            { name: "Your alliance controls ONE Circle", time: "2024-10-03 12:00:00" },
            { name: "Waiting period for activation Altar of Darkness", time: "2024-10-05 00:00:00" },
            { name: "Your troops defeated 3 Dark Stalkers", time: "2024-10-05 12:00:00" },
            { name: "Your alliance destroyed 50 lvl. 9 barbarian forts", time: "2024-10-07 00:00:00" },
            { name: "Waiting period for activation lvl 6 pass", time: "2024-10-09 00:00:00" },
            { name: "Your alliance controlled ONE lvl. 6 pass", time: "2024-10-09 12:00:00" },
            { name: "Kill 100k lvl 36+ barbs", time: "2024-10-11 00:00:00" },
            { name: "Your alliance destroyed 50 lvl. 10 barbarian forts", time: "2024-10-12 00:00:00" },
            { name: "Waiting period for Great Ziggurat", time: "2024-10-14 00:00:00" },
            { name: "Your alliance controls the Great Ziggurat", time: "2024-10-14 12:00:00" },
            { name: "Waiting period for lvl. 4 passes (unsealed)", time: "2024-10-17 12:00:00" },
            { name: "Your camp controlled 3 other camps' Crusader camps", time: "2024-10-18 00:00:00" },
            { name: "Your troops killed 1,000,000 troops from other camps", time: "2024-10-19 12:00:00" },
            { name: "Your camp controlled 1 other camp's Crusader Fortress", time: "2024-10-20 12:00:00" }
        ];
